...
Полный чеклист живого прогона (измерения контекста, ворота, `/stop`, подтверждения) — в [`ПЕРВЫЙ_ЗАПУСК.md`](ПЕРВЫЙ_ЗАПУСК.md).
...
├── ТЗ_слойный_агент.md       ← полное ТЗ слоёв
├── ПЕРВЫЙ_ЗАПУСК.md          ← чеклист живого прогона
...
| [`ТЗ_слойный_агент.md`](ТЗ_слойный_агент.md) | полное ТЗ слоёв, ворот, паков |
| [`ПЕРВЫЙ_ЗАПУСК.md`](ПЕРВЫЙ_ЗАПУСК.md) | чеклист приёмки на живом железе |
